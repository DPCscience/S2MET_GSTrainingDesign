...
## # CV0 and CV00 future prediction
## 
## 
## 
...
## CV-zero
cv_zero_future_prediction <- CV_zero_future %>%
...
## Save
save("cv_zero_future_prediction", file = file.path(result_dir, "cross_future_validation_CVzero.RData"))
