...
## CV-zero
cv_zero_loeo_prediction <- CV_zero_loeo %>%
...
cv_zero_loeo_prediction <- bind_rows(cv_zero_loeo_prediction)



## Save
save("cv_zero_loeo_prediction", file = file.path(result_dir, "cross_loeo_validation_CVzero.RData"))
